...
export default function Products({data, index, logo}) {
  return (
    <div className={`d-flex my-4 ${index%2!==0?"flex-md-row-reverse":"flex-md-row"}  flex-column mx-auto`} style={{width:"80vw"}} >
          <div>
          ...
          <div className='w-100 p-4 text-start'>
            <div>
              ...
              <p className='h6 text-muted' style={{overflowY: "hidden"}} >{data.para}</p>
              <div>
            ...
            <button type="button" className="my-4 btn btn-primary">Get Quote</button>
            </div>
            </div>
