        ...
        <div className='justify-content-center d-flex mt70'>
          <div className='px-4 py-4 mx-4 bg-light mdWidth75' style={{borderLeft:"5px solid #F304AD"}} >
           ...
           <div className='text-start'>
              ...
              <p className='h6 text-muted my-3' style={{fontWeight:"1",overflowY: "hidden"}} >Being a part of Infinity Advertising Services, it has been our intrinsic forte to infuse and bring creativity in our designs and deliverables. The state-of-the-art plant covers the whole gamut of printing needs, including direct marketing, brochures, magazines, catalogues and marketing & publishing related materials with unparalleled quality in a quick turnaround time.</p>
            </div>
