            ...
            <Accordion style={{backgroundColor:"white"}} defaultActiveKey={['0']} alwaysOpen>
                <Accordion.Item eventKey="0">
                    ...
                    <Accordion.Body>
                        ...
                        <p  className='para heading'>PrintWeek India's Rahul Kumar caught up with Adlakha after an international tour and understand what does SAARC nations award meant to him. ....<a className='more' href='https://www.printweek.in/news/infinity-sister-concern-printsmith-wins-awards-24951' target='blank'> Read More</a></p>
                        </div>
                ...
                <Accordion.Item eventKey="2">
                    ...
                    <Accordion.Body>
                        ...
                        <p  className='para'> Faridabad-based APL Machinery is the Indian representative of the US-based manufacturer of UV and LED curing systems Air Motion Systems... <a className='more' href='https://www.printweek.in/news/coimbatore-apl-organising-led-uv-house-delhi-jan-11493' target='blank'> Read More</a></p>
                        </div>
                ...
                <Accordion.Item eventKey="3">
                    ...
                    <Accordion.Body>
                        ...
                        <p className='para'>“The Spica has a quick makeready. Its speed of printing up to 13,000 impressions in an hour improved firm’s productivity,” explained Vijay Adlakha, director, Infinity advertising services....<a className='more' href='https://www.printweek.in/news/printsmith-ups-capacity-faridabad-12228' target='blank'> Read More</a></p>
                        </div>
